...
test_expect_success GPG 'test signature atom with grade option and bad signature' '
	...
	EOF
	git for-each-ref refs/tags/third-signed --format="%(signature:grade)%0a%(signature:key)%0a%(signature:signer)%0a%(signature:fingerprint)%0a%(signature:primarykeyfingerprint)" >actual &&
	test_cmp expect actual
'
...
test_expect_success GPG 'show untrusted signature with custom format' '
	...
	EOF
	git for-each-ref refs/tags/signed-fourth --format="%(signature:grade)%0a%(signature:key)%0a%(signature:signer)%0a%(signature:fingerprint)%0a%(signature:primarykeyfingerprint)" >actual &&
	test_cmp expect actual
'
...
test_expect_success GPG 'show untrusted signature with undefined trust level' '
	...
	D4BE22311AD3131E5EDA29A461092E85B7227189
	EOF
	git for-each-ref refs/tags/fifth-signed --format="%(signature:trustlevel)%0a%(signature:key)%0a%(signature:signer)%0a%(signature:fingerprint)%0a%(signature:primarykeyfingerprint)" >actual &&
	test_cmp expect actual
'
...
test_expect_success GPG 'show untrusted signature with ultimate trust level' '
	...
	73D758744BE721698EC54E8713B6F51ECDDE430D
	EOF
	git for-each-ref refs/tags/seventh-signed --format="%(signature:trustlevel)%0a%(signature:key)%0a%(signature:signer)%0a%(signature:fingerprint)%0a%(signature:primarykeyfingerprint)" >actual &&
	test_cmp expect actual
'
...
test_expect_success GPG 'show unknown signature with custom format' '
	...
	EOF
	GNUPGHOME="$GNUPGHOME_NOT_USED" git for-each-ref refs/tags/fifth-signed --format="%(signature:grade)%0a%(signature:key)%0a%(signature:signer)%0a%(signature:fingerprint)%0a%(signature:primarykeyfingerprint)" >actual &&
	test_cmp expect actual
'
...
test_expect_success GPG 'show lack of signature with custom format' '
	...
	EOF
	git for-each-ref refs/tags/eigth-unsigned --format="%(signature:grade)%0a%(signature:key)%0a%(signature:signer)%0a%(signature:fingerprint)%0a%(signature:primarykeyfingerprint)" >actual &&
	test_cmp expect actual
'
